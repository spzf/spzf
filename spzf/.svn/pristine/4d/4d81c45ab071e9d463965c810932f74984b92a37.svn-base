package com.spzf.web.controller.dictionary;
 ...
 */
@Controller
@RequestMapping("/managment/dictionary")
public class DictionaryController extends BaseController{
	...
	public String list(String sessionId,ModelMap model) {
		...
		return "/dictionary/dictionary_page";
	}
	...
	public String insertUI(String sessionId,String pcode,ModelMap model,String systemSn){
		...
		model.addAttribute("sessionId", sessionId);
		return "/dictionary/dictionary_insert";
	}
	...
	public String updateUI(String sessionId,ModelMap model){
		model.addAttribute("sessionId", sessionId);
		return "/dictionary/dictionary_update";
	}
