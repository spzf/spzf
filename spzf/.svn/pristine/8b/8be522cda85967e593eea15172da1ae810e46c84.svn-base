package com.spzf.web.controller.loginlog;
 ...
 */
@Controller
@RequestMapping("/managment/loginLog")
public class LoginLogController extends BaseController{
	...
	public String list(String sessionId,ModelMap model){
		...
		return "/loginlog/login_log_page";
	}
	...
	public String insertUI(String sessionId,ModelMap model){
		model.addAttribute("sessionId", sessionId);
		return "/loginlog/login_log_insert";
	}
	...
	public String updateUI(String sessionId,ModelMap model){
		model.addAttribute("sessionId", sessionId);
		return "/loginlog/login_log_update";
	}
