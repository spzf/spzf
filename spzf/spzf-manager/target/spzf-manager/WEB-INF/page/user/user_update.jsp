        ...
        <div style="margin:20px auto;">
            <table class="form-tb">
                ...
                <tr>
                    <th>所属系统：</th>
                    <td colspan="3">  
                    	<select name="systemIds" style="width:240px;" class="easyui-combotree" data-options="url:'${basePath}managment/user/getUserSystemIds.do?sessionId=${sessionId}&userId=${userId }',required:true,loadFilter:pagerFilterSys,readonly:true,multiple:true"></select>
                    </td>
                </tr>
            </table>
        </div>      
