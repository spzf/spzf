package com.spzf.web.controller.user;
...
import com.spzf.service.role.IRoleService;
...
public class UserController extends BaseController{
	...
	public String insertUI(String sessionId,ModelMap model,String userId){
		model.addAttribute("sessionId", sessionId);
		List<ICSystem> cSystems = getUserSystemIds(userId);
		model.addAttribute("sys", cSystems);
	...
	public String getRoles(String userId){
		...
		try {
			roles=this.roleService.getAll(new Role());
	...
	public List<ICSystem> getUserSystemIds(String userId){
		List<ICSystem> sy=null;
